...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OneGiftLink — Creator gifting infrastructure per brand DTC" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "OneGiftLink - Creator gifting per brand DTC" },
      {
        ...
        content:
          "Basta DM su Instagram e fogli Excel. Manda un link privato, il creator sceglie taglia, colore e indirizzo. Tu spedisci e vedi chi posta.",
      },
